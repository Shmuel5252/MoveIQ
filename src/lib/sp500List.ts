// Snapshot of S&P 500 constituents (symbol + company name), scraped from
// Wikipedia's "List of S&P 500 companies" on 2026-06-29. This is a static
// seed list used by scripts/syncSectorData.ts to look up each company's
// live sector/industry via yahoo-finance2 — it does not need to be 100%
// up to date; re-scrape occasionally (index changes a few times a year).
export interface SP500Entry {
  symbol: string;
  name: string;
}

export const sp500List: SP500Entry[] = [
  { symbol: "MMM", name: "3M" },
